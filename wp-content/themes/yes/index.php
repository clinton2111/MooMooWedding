<?php get_header(); ?>
	...
	<?php if (have_posts()) : ?>
	    ...
	    <section id="blog" data-posts-per-page="<?php echo get_option('posts_per_page'); ?>">
	        <?php if(isset($lt_yes_theme['blog-subtitle']) && $lt_yes_theme['blog-subtitle'] != '' ) { ?>
		        <header class="section-header">
		            <p class="section-tagline">
		            	<?php echo esc_attr($lt_yes_theme['blog-subtitle']); ?>
		            </p>
		        </header>
		    <?php } ?>
	        <div class="pattern">
			...
			<?php if(function_exists('lt_retrieve_posts')) { ?>
				</div><div class="clearfix"></div><div class="timeline-button"><a id="more-posts" href="#" class="yes_button"><?php _e('Load More', 'lt_yes'); ?></a></div>
